# Tailwind CSS v4 — Referencia rápida

> Skill: `.agents/skills/tailwind-design-system/`.
> El usuario usa Tailwind v4 con Vite.
...
```tsx
// Convención de nombres (como Material Design 3)
...
Si el proyecto usa `class` strategy:
