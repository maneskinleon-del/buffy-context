...
| Suite de tests | `scripts/tests/run-tests.sh` | ✅ 164 checks full / 148 quick |
...
- ✅ **Suite determinística**: 164 checks full / 148 `--quick` (7 SKIP: 4 sandbox + 3 changelog).
...
bash scripts/tests/run-tests.sh           # 164 OK esperado
bash scripts/tests/run-tests.sh --quick   # 148 OK esperado
